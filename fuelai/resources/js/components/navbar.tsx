...
export default function Navbar() {
    return (
        <div className="fixed top-0 z-50 navbar w-full bg-base-100 shadow-lg">
            <div className="navbar-start">
                <Link href="/" className="btn text-xl font-bold btn-ghost">
                    FuelAI
                </Link>
            ...
            <div className="navbar-center">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <li>
                        <Link href="/recipe-generation" className="btn btn-ghost">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                    ...
                    <li>
                        <Link href="/image_rec" className="btn btn-ghost">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
            ...
            <div className="navbar-end">
                <div className="flex items-center gap-2">
                    <Link href="/mobile" className="btn btn-ghost">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
