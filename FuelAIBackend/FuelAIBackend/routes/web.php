...
//TEMPORARY TEST ROUTES - for 60% demo presentation
Route::middleware('auth')->group(function () {
    Route::get('/test-settings', [SettingsController::class, 'show']);
    Route::get('/test-threads', [ForumThreadController::class, 'index']);
    Route::get('/test-meal-plan', [MealPlanController::class, 'index']);
