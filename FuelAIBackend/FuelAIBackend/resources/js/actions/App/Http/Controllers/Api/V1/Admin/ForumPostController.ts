...
/**
* @see \App\Http\Controllers\Api\V1\Admin\ForumPostController::destroy
* @see app/Http/Controllers/Api/V1/Admin/ForumPostController.php:18
* @route '/api/admin/posts/{post}'
*/
...
const ForumPostController = { destroy }
