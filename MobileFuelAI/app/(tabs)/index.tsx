...
import { View, useColorScheme, Image, Text, TouchableOpacity, Modal, TextInput, Alert, ActivityIndicator, ScrollView } from "react-native";
...
export default function Index() {
    ...
    const fetchTasks = async () => {
        try {
            ...
            // Get incomplete tasks with deadlines, sorted by deadline (soonest first), limited to 5.
    ...
    // Handle profile update.  I never added ability to update pfp
    ...
    return (
        <ThemeProvider value={isDark ? DarkTheme : DefaultTheme}>
            <View className={`flex-1 ${isDark ? "bg-primary" : "bg-secondary"}`}>
                <ScrollView className="flex-1 px-6 py-12" contentContainerStyle={{ alignItems: 'center', paddingBottom: 40 }}>
                    {/* Avatar */}
